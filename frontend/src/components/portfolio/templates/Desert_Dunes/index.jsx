...
function DuneDivider({ fill = C.sand, flip = false }) {
  return (
    <div style={{ lineHeight: 0, transform: flip ? 'rotate(180deg)' : 'none' }}>
      ...
      >
        <path
          d="M0,60 C180,20 360,100 540,55 C720,10 900,90 1080,50 C1260,10 1380,80 1440,60 L1440,120 L0,120 Z"
          fill={fill}
        />
      </svg>
    </div>
...
function DuneDividerTall({ fill = C.sand }) {
  return (
    <div style={{ lineHeight: 0 }}>
      ...
      >
        <path
          d="M0,80 C120,30 300,130 480,70 C660,10 840,120 1020,65 C1200,10 1340,100 1440,70 L1440,160 L0,160 Z"
          fill={fill}
        />
        <path
          d="M0,100 C200,60 400,140 600,90 C800,40 1000,130 1200,85 C1320,60 1400,100 1440,90 L1440,160 L0,160 Z"
          fill={fill}
          opacity="0.5"
        />
      </svg>
    ...
    >
      <div
        style={{
          width: 32,
          height: 2,
          background: light ? C.sandLight : C.terracotta,
          borderRadius: 99,
        }}
      />
      <span
      ...
      >
        ...
        >
          ...
          >
            ...
            <span style={{ color: C.terracottaLight }}>.</span>
          </span>
            ...
            {links.map((link, i) => (
              <motion.button
                ...
                style={{
                  ...
                  textAlign: 'left',
                  padding: '12px 0',
                  borderBottom: `1px solid ${C.sandDark}20`,
                }}
              >
                {link}
              </motion.button>
          ...
          >
            <div
              style={{
                ...
                alignItems: 'center',
                gap: 6,
                background: `${C.sandDark}30`,
                border: `1px solid ${C.sandDark}50`,
                borderRadius: 99,
                padding: '6px 14px',
          ...
          >
            <a
              ...
              style={{
                ...
                boxShadow: `0 4px 24px ${C.amber}60`,
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.transform = 'translateY(-2px)';
                e.currentTarget.style.boxShadow = `0 8px 32px ${C.amber}80`;
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = 'translateY(0)';
                e.currentTarget.style.boxShadow = `0 4px 24px ${C.amber}60`;
              }}
            >
            ...
            <a
              ...
              onMouseLeave={(e) => {
                e.currentTarget.style.borderColor = `${C.sandDark}50`;
                e.currentTarget.style.color = C.sandMid;
                e.currentTarget.style.transform = 'translateY(0)';
              }}
            >
          ...
          >
            ...
            <motion.div
              ...
              style={{
                ...
                alignItems: 'center',
                justifyContent: 'center',
                boxShadow: `0 4px 20px ${C.amber}60`,
                zIndex: 3,
              }}
            >
                      ...
                      >
                        <motion.div
                          ...
                          style={{
                            height: '100%',
                            borderRadius: 99,
                            background: `linear-gradient(90deg, ${colors.bg}, ${C.amber})`,
                          }}
                        />
                      </div>
                    </div>
                ...
                >
                  ...
                  <div
                    style={{
                      position: 'absolute',
                      inset: 0,
                      background: `linear-gradient(135deg, ${C.duskDeep}40, transparent)`,
                    }}
                  />
                  <div
                    style={{
                  ...
                  <div style={{ display: 'flex', gap: 12 }}>
                    ...
                    <a
                      ...
                      style={{
                        ...
                        color: C.sandMid,
                        background: `${C.sandDark}20`,
                        border: `1px solid ${C.sandDark}40`,
                        padding: '9px 18px',
                        borderRadius: 8,
                        textDecoration: 'none',
                        transition: 'all 0.2s',
                      ...
                      onMouseLeave={(e) => {
                        e.currentTarget.style.borderColor = `${C.sandDark}40`;
                        e.currentTarget.style.color = C.sandMid;
                      }}
                    >
                      <Github size={13} /> Code
                ...
                >
                  ...
                  <div
                    style={{
                      position: 'absolute',
                      inset: 0,
                      background: `linear-gradient(to top, ${C.duskDeep}, transparent)`,
                    }}
                  />
                </div>
            ...
            <div style={{ paddingLeft: 56 }}>
              {data.experience.map((exp, i) => (
                <motion.div
                  ...
                  style={{
                    position: 'relative',
                    marginBottom: i < data.experience.length - 1 ? 48 : 0,
                  }}
                >
                  <div
                    style={{
                  ...
                  <div
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.boxShadow = `0 8px 32px ${C.shadowDeep}`;
                    }}
                    onMouseLeave={(e) => {
          ...
          {data.testimonials.map((testimonial, i) => (
            <motion.div
              ...
              style={{
                ...
                border: `1px solid ${C.sandDark}25`,
                borderRadius: 20,
                padding: 32,
                position: 'relative',
              }}
            >
              ...
              <div
                style={{
                  ...
                  alignItems: 'center',
                  gap: 12,
                  borderTop: `1px solid ${C.sandDark}25`,
                  paddingTop: 20,
                }}
              >
                <img
...
function Contact() {
  ...
  const inputBase = {
    ...
    color: C.duskDeep,
    background: C.warmWhite,
    border: `1.5px solid ${C.sandMid}80`,
    borderRadius: 10,
    padding: '12px 16px',
    outline: 'none',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
          <div>
            ...
            >
              ...
              something
              <br />
              <em style={{ color: C.terracotta }}>remarkable</em>
            </motion.h2>
            <motion.p
              initial="hidden"
              animate={inView ? 'visible' : 'hidden'}
                ...
                >
                  <div
                    style={{
                      ...
                      justifyContent: 'center',
                      margin: '0 auto 20px',
                      boxShadow: `0 8px 24px ${C.amber}50`,
                    }}
                  >
                ...
                >
                  {[
                    ...
                    <div key={name}>
                      ...
                      <input
                        ...
                        style={inputBase}
                        onFocus={(e) => {
                          e.target.style.borderColor = C.terracotta;
                          e.target.style.boxShadow = `0 0 0 3px ${C.terracotta}20`;
                        }}
                        onBlur={(e) => {
                          e.target.style.borderColor = `${C.sandMid}80`;
                  ...
                  <button
                    ...
                    onMouseEnter={(e) => {
                      if (status !== 'sending') {
                        e.currentTarget.style.transform = 'translateY(-2px)';
                        e.currentTarget.style.boxShadow = `0 8px 28px ${C.amber}70`;
                      }
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.transform = 'translateY(0)';
                      e.currentTarget.style.boxShadow = `0 4px 20px ${C.amber}50`;
                    }}
                  >
                    {status === 'sending' ? (
                      <>
                        <Wind
                          size={16}
                          style={{
                            animation: 'dune-windspin 1s linear infinite',
                          }}
                        />{' '}
                        Sending...
                      </>
